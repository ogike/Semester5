...
# Egy tehén napi tejhozamát normális eloszású valószínûségi változóval, 
# m = 22,1 liter várható értékkel és szigma = 1,5 liter szórással modellezzük.
# Mi annak a valószínûsége, hogy egy adott napon a tejhozam 23 és 25 liter közé esik?
...
# 110 várható értékkel és 10 szórással. Mi a valószínûsége, hogy egy véletlenszerûen 
...
# garanciaidõn belül javítani, ha a készülék élettartama 10 év várható értékû és 
# 2 év szórású normális eloszlással közelíthetõ.
...
# 8. Magyarországon 2017 tavaszán a 16 éves és idõsebb népességen belül a férfiak 
...
# Tapasztalatok szerint az út hossza, amit egy bizonyos típusú robogó megtesz az elsõ
# meghibásodásáig exponenciális eloszlású valószínûségi változó. Ez a távolság 
# átlagosan 6000 km. Mi a valószínûsége annak, hogy egy véletlenszerûen
# kiválasztott robogó
